...
<div class="site-content clear-fix">
	<div class="site-intro clear-fix">
		<div class="intro-item">
			<a href="/section.php?selected=web"><img src="/images/carousel1.jpg" alt="Martha Stewart Videos"/><h4 class="intro-item-title">Martha Stewart Videos</h4></a>
		</div>
		<div class="intro-item">
			<a href="/section.php?selected=web"><img src="/images/carousel2.jpg" alt="My Eyes Are Hungry Website"/><h4 class="intro-item-title">My Eyes Are Hungry Website</h4></a>
		</div>
		<div class="intro-item">
			<a href="/section.php?selected=web"><img src="/images/carousel3.jpg" alt="Jingle Ball 2011 Website"/><h4 class="intro-item-title">Jingle Ball 2011 Website</h4></a>
		</div>
		<div class="intro-item">
			<a href="/section.php?selected=vector2d"><img src="/images/carousel4.jpg" alt="Vector Art"/><h4 class="intro-item-title">Vector Art</h4></a>
		</div>
	</div>
	...
	<section class="mod-wrap clear-fix">
		<article class="mod-half">
			<div class="mod-inner">
				...
				<h5 class="sub-title">Employment</h5>
				Currently at <a href="http://www.meredith.com" target="_blank" rel="nofollow">Meredith</a> as a <i>Senior Web Developer</i>
	
				<h5 class="sub-title">Education</h5>
				Graduated from <a href="http://www.purdue.edu" target="_blank" rel="nofollow">Purdue</a><br/>
				Bachelor of Science in <i>Computer Graphics</i><br/>
				Minor in <i>Fine Arts</i> and <i>Computer Technology</i>
	
				<h5 class="sub-title">Email</h5>  
				meskauskis @ gmail . com<br/> 
	
				<h5 class="sub-title">Resume</h5>
				<a href="/resume/resume_neil_meskauskis.doc">Download (Word format)</a> 
			</div>
		</article>
		
		<article class="mod-half last">
			<div class="mod-inner">
				<h3 class="mod-title2">My Favorite Sites</h3>
				
				<h5 class="sub-title">General</h5>
				<a href="http://www.thebestdesigns.com" target="_blank" rel="nofollow">Best Designs</a><br />
				<a href="http://www.cgtalk.com" target="_blank" rel="nofollow">CgTalk</a><br />
				<a href="http://www.thefwa.com" target="_blank" rel="nofollow">FWA</a><br />
				<a href="http://www.kotaku.com" target="_blank" rel="nofollow">Kotaku</a><br />
				<a href="http://www.mashable.com" target="_blank" rel="nofollow">Mashable</a><br />
				<a href="http://www.wired.com" target="_blank" rel="nofollow">Wired</a><br />
				
				<h5 class="sub-title">Helpful</h5>
				<a href="http://caniuse.com/" target="_blank" rel="nofollow">Can I Use?</a><br />
				<a href="http://api.jquery.com/" target="_blank" rel="nofollow">jQuery Doc</a><br />
				<a href="http://php.net/manual/en/" target="_blank" rel="nofollow">PHP Doc</a><br />
				<a href="http://stackoverflow.com/" target="_blank" rel="nofollow">Stack Overflow</a><br />
